...
__export(index_exports, {
  AnyInputQuoteWithdrawal: () => AnyInputQuoteWithdrawal,
  ApiError: () => ApiError,
...
// src/models/AnyInputQuoteWithdrawal.ts
var AnyInputQuoteWithdrawal;
((AnyInputQuoteWithdrawal2) => {
  let status;
  ((status2) => {
    status2["SUCCESS"] = "SUCCESS";
    status2["FAILED"] = "FAILED";
  })(status = AnyInputQuoteWithdrawal2.status || (AnyInputQuoteWithdrawal2.status = {}));
})(AnyInputQuoteWithdrawal || (AnyInputQuoteWithdrawal = {}));
...
((TokenResponse2) => {
  ...
  ((blockchain2) => {
    ...
    blockchain2["LTC"] = "ltc";
    blockchain2["XLAYER"] = "xlayer";
    blockchain2["MONAD"] = "monad";
    blockchain2["BCH"] = "bch";
    blockchain2["ADI"] = "adi";
    blockchain2["PLASMA"] = "plasma";
    blockchain2["SCROLL"] = "scroll";
    blockchain2["STARKNET"] = "starknet";
    blockchain2["ALEO"] = "aleo";
...
var OneClickService = class {
   ...
   * @throws ApiError
   */
  static getAnyInputQuoteWithdrawals(depositAddress, depositMemo, timestampFrom, page, limit, sortOrder) {
    return request(OpenAPI, {
      method: "GET",
